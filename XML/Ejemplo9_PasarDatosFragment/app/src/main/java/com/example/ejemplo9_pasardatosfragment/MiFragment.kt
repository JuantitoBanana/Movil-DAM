...
class MiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.tvDato2.text = param1

        binding.bPasarDato2.setOnClickListener {
            var sacoDatos= Bundle()
            sacoDatos.putString("dato", binding.tietDato2.text.toString())
            parentFragmentManager.setFragmentResult("DatoEnviar", sacoDatos)
        }
